...
- [ ] Choose and configure the permanent Visual Studio Marketplace publisher ID.
...
The implementation work for M3 is otherwise complete. The remaining items are the permanent publisher identity and external release configuration.
